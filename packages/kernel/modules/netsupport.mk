...
define KernelPackage/ipvs
  ...
  FILES:= \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_dh.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_ftp.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_lblc.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_lblcr.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_lc.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_nq.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_rr.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_sed.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_sh.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_wlc.ko \
	$(LINUX_DIR)/net/netfilter/ipvs/ip_vs_wrr.ko \
	$(LINUX_DIR)/net/netfilter/xt_ipvs.ko
  AUTOLOAD:=$(call AutoLoad,30,ipvs))
endef

define KernelPackage/ipvs/description
 Kernel modules for IP Virtual Server support
endef
